class Account:
    ...
    def check_balance(self):
        print(f' your amount {self._balance}')
    def deposite(self,amount):
        self._balance +=amount
        print(f"your amount succefuly created {self._balance}")
        return self._balance
    def withdraw(self,amount):
        if self._balance >= amount:
            self._balance -= amount
            print(f" your amount succesfully withdrowed{self._balance}")
        else:
...
class Savings_Account(Account):
    def calculate_intrest(self):
        interest  = 0.03
        interest = self._balance * interest
